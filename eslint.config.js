...
export default [
  ...
  },
  {
    ...
    ignores: [
      ...
      'executor/src/ollama-client.ts', // (b) loopback Ollama on the compiled 127.0.0.1:11434 origin (policy-overridable, never server-supplied); safeFetch refuses loopback by design, so the pinned transport cannot express this call.
