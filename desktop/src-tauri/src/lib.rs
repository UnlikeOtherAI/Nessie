...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            executor_companion::code_pairing::executor_companion_pairing_start,
            executor_companion::code_pairing::executor_companion_pairing_confirm,
            executor_companion::code_pairing::executor_companion_pairing_cancel,
            ...
            local_inference::local_inference_start_direct_host,
            local_inference::local_inference_stop_direct_host,
            local_inference::local_inference_sign_binding_consent,
