 ...
 * is deliberately NOT inside these functions — bootstrap and workspace
...
export const listTeamsForOrganization = async (
  ...
  return teams.map((team) => ({
    ...
    // UOA holds a bound workspace's name, so a rename here is relayed to UOA
    ...
    externallyManaged: team.externalWorkspaceId !== null,
