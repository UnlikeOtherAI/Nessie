...
const assertTeamInOrganization = async (
  ...
  if (!team) {
    throw new MailboxConnectionError('team_not_found', 'That team is not in this workspace.')
  }
}
...
export const setMailboxAgentAccess = async (
  ...
  if (!agent) {
    throw new MailboxConnectionError('agent_not_found', 'That agent is not in this workspace.')
  }
