...
export const ConfigEnvMap = {
  ...
  NESSIE_RATE_LIMIT_HOSTS_TEAM_IP_MAX: 'api.rateLimit.hostsTeamIp.max',
  NESSIE_RATE_LIMIT_HOSTS_TEAM_IP_WINDOW_MS: 'api.rateLimit.hostsTeamIp.windowMs',
  ...
  NESSIE_RATE_LIMIT_EXECUTOR_ATTACHMENT_IP_MAX: 'api.rateLimit.executorAttachmentIp.max',
  NESSIE_RATE_LIMIT_EXECUTOR_ATTACHMENT_IP_WINDOW_MS: 'api.rateLimit.executorAttachmentIp.windowMs',
...
const DEFAULT_CONFIG: NessieConfig = {
  ...
  api: {
    ...
    rateLimit: {
      ...
      hostsTeamIp: { max: 60, windowMs: 60_000 },
      ...
      executorAttachmentIp: { max: 120, windowMs: 60_000 },
