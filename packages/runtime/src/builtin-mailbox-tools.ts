...
export const MAILBOX_TOOL_DEFINITIONS: BuiltinToolDefinition[] = [
  {
    ...
    parameters: {
      properties: {
        ...
        to: { description: 'Proposed recipient addresses.', items: { type: 'string' }, type: 'array' },
        cc: { description: 'Proposed CC recipient addresses.', items: { type: 'string' }, type: 'array' },
        bcc: { description: 'Proposed BCC recipient addresses.', items: { type: 'string' }, type: 'array' },
        subject: { description: 'Proposed subject line.', type: 'string' },
        text: { description: 'Proposed plain-text message body.', type: 'string' },
      },
      type: 'object',
    },
