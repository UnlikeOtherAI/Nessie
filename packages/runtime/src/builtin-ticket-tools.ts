...
export const TICKET_TOOL_DEFINITIONS: BuiltinToolDefinition[] = [
  ...
  {
    id: 'ticket_search', category: 'projects', label: 'Search Tickets', personalAssistantOnly: true, projectDelegatedOnly: true,
  ...
  {
    id: 'ticket_search_remote', category: 'projects', label: 'Search Provider Tickets', personalAssistantOnly: true, projectDelegatedOnly: true,
  ...
  {
    id: 'ticket_people_read', category: 'projects', label: 'Read Ticket People', personalAssistantOnly: true, projectDelegatedOnly: true,
  ...
  {
    id: 'ticket_fields_read', category: 'projects', label: 'Read Ticket Fields', personalAssistantOnly: true, projectDelegatedOnly: true,
  ...
  {
    id: 'ticket_iteration_set', category: 'projects', label: 'Set Ticket Iteration', personalAssistantOnly: true, projectDelegatedOnly: true,
  ...
  {
    id: 'ticket_archive_done', category: 'projects', label: 'Archive Completed Tickets', personalAssistantOnly: true, projectDelegatedOnly: true,
