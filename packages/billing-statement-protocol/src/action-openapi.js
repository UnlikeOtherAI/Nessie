...
import { billingCancellationConfirmationV1JsonSchema, billingCancellationConfirmRequestJsonSchema, billingCancellationPreviewV1JsonSchema, billingCancellationSelectionJsonSchema, billingErrorEnvelopeJsonSchema, billingHostedRedirectResponseJsonSchema, } from './action-schema.js';
...
export const billingConsumerActionV1OpenApiDocument = {
    ...
    info: {
        ...
        description: 'OpenAPI 3.1 components and synthetic fixtures for product-hosted redirects and UOA cancellation.',
    },
    paths: {},
    components: {
        schemas: {
