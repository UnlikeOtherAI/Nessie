...
export const billingStatementV2ConformanceFixture = {
        ...
        ledger_snapshots: [
            {
                ...
                captured_at: billingStatementV1ConformanceFixture.pinned_inputs.ledger_snapshots[1]?.captured_at ??
                    '2026-07-20T11:59:00.000Z',
                sha256: billingStatementV1ConformanceFixture.pinned_inputs.ledger_snapshots[1]?.sha256 ??
    ...
    connected_service_usage: {
        ...
        description: 'Team-wide raw usage across connected services. Other services are shown for transparency and are not added to this statement total.',
        ...
        services: [
            {
                ...
                description: 'DeepWater used 1,000 raw tokens across this team. DeepWater originated 56.00%; Nessie originated 44.00%.',
                totals: {
                    calls: '10',
                    usage: [
                        {
