...
const positiveUsdEquivalentPattern = '^(?:[1-9][0-9]*(?:\\.[0-9]{1,8})?|0\\.(?=[0-9]{1,8}$)[0-9]*[1-9][0-9]*)$';
export function moneySchema(options = {}) {
...
export function creditAmountSchema(options = {}) {
...
export function billingSubjectActionBodySchema(properties = {}, required = []) {
    return {
