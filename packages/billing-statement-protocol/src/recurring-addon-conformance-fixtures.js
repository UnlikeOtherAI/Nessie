...
export const billingRecurringAddonV1ConformanceFixtures = {
    recurring_addons: {
        schema_version: 1,
        ...
        offers: [
            {
                ...
                entitlement: {
                    ...
                    description: 'UOA resolves the runtime entitlement independently; the product does not infer it from payment state.',
                },
                subscription: {
