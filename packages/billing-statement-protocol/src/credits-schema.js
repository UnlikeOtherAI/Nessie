import { billingCreditsAutoTopUpDisableActionJsonSchema, billingCreditsAutoTopUpRecoverActionJsonSchema, billingCreditsAutoTopUpSetupActionJsonSchema, billingCreditsAutoTopUpUpdateActionJsonSchema, billingCreditsTopUpActionJsonSchema, nullableBillingCreditsAction, } from './credits-action-schema.js';
import { creditAmountSchema, moneySchema } from './funding-schema-primitives.js';
import { billingCreditsManagerRecentEntriesJsonSchema, billingCreditsManagerSummaryJsonSchema, billingCreditsManagerConsentJsonSchema, billingCreditsManagerPaymentMethodJsonSchema, billingCreditsMemberRecentEntriesJsonSchema, billingCreditsMemberSummaryJsonSchema, billingCreditsMemberPaymentMethodJsonSchema, billingCreditsMemberAutomaticTopUpJsonSchema, billingCreditsVisibilityDiscriminatorJsonSchema, } from './credits-visibility-schema.js';
...
export const billingCreditsV1JsonSchema = {
    ...
    description: 'Display-ready shared team credits, fixed top-up offers, bounded automatic top-up options, and immutable entry history.',
    type: 'object',
                        ...
                        options: {
                            ...
                            items: {
                                ...
                                properties: {
                                    ...
                                    setup_action: nullableBillingCreditsAction(billingCreditsAutoTopUpSetupActionJsonSchema),
                                    update_action: nullableBillingCreditsAction(billingCreditsAutoTopUpUpdateActionJsonSchema),
                                },
                            },
                        },
