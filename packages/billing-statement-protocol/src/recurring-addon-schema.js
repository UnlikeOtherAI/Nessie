import { billingSubjectActionBodySchema, moneySchema, nullableDateTimeSchema, } from './funding-schema-primitives.js';
import { BILLING_RECURRING_ADDONS_CANCELLATION_CONFIRM_PATH, BILLING_RECURRING_ADDONS_CANCELLATION_PREVIEW_PATH, BILLING_RECURRING_ADDONS_CHECKOUT_PATH, BILLING_RECURRING_ADDONS_SCHEMA_PATH, BILLING_RECURRING_ADDONS_SCHEMA_VERSION, } from './recurring-addon-types.js';
import { billingRecurringAddonManagerSubscriptionJsonSchema, billingRecurringAddonMemberSubscriptionJsonSchema, billingRecurringAddonVisibilityDiscriminatorJsonSchema, } from './recurring-addon-visibility-schema.js';
    ...
    properties: {
        ...
        request: {
            ...
            properties: {
                ...
                body: billingSubjectActionBodySchema({ offer_id: { type: 'string', minLength: 1, maxLength: 256 } }, ['offer_id']),
            },
        },
    },
};
    ...
    properties: {
        ...
        request: {
            ...
            properties: {
                ...
                body: billingSubjectActionBodySchema({ subscription_id: { type: 'string', minLength: 1, maxLength: 256 } }, ['subscription_id']),
            },
        },
    },
};
...
export const billingRecurringAddonProtocolV1JsonSchema = {
    ...
    description: 'Exact display model and single-add-on subscription cancellation messages. Runtime entitlements remain UOA-resolved.',
    oneOf: [
