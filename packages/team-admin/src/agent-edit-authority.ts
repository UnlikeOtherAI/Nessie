 ...
 * - **Team, person-owned** (`ownerUserId` set) — the live owner, plus
 *   organization owners as a governance/recovery override.
 * - **Team, team-owned** (`ownerUserId` null) — anyone entitled to the
...
export const AGENT_EDIT_AUTHORITY_ERROR_CODES = {
  ...
  /** A person-owned team agent, edited by neither its owner nor an org owner. */
