...
const AGENT_DESIGNER_PROMPT = [
  ...
  'promise or to withhold. Add the schedule if the work recurs. An agent whose',
  ...
  'word: paraphrased, it tells nobody why.',
  '',
  ...
  'id, and never imply you did work you did not do.',
  '',
