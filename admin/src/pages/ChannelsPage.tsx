      ...
      >
        ...
        {selectedAgent ? (
          <ChatToolDock
            ...
            hideConversations={activeChannel?.type === 'dm' && conversationAgent !== null}
            onClose={closeTool}
        ...
        {activeChannel ? (
          <ConversationInfoFlow
            ...
            channelUsers={channelUsers}
            agentTools={availableChatTools(chatToolAgents, activeChannel.type === 'dm' && conversationAgent !== null)}
            me={me}
