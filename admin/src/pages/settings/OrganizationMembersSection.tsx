...
import { useWorkspaceInvitations } from '../../facades/users/workspace-members'
...
import { InviteToWorkspaceCard, InvitationRow } from './WorkspaceMembersSection'
 ...
 * WORKSPACE_TEAM_ROLE_OPTIONS). Ownership transfer is a separate UOA
 ...
 * so the invite card is the existing workspace one, with one line naming the
    ...
    <div className="grid gap-4 xl:grid-cols-2">
      ...
      {canManage ? (
        <div className="grid content-start gap-4">
          <InviteToWorkspaceCard teamLabel={inviteTeamLabel} />
          <PendingInvitations />
        </div>
      ) : null}
    </div>
