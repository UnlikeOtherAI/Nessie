...
export const WORKSPACE_TEAM_ROLE_OPTIONS = [
...
/** Agents that cannot be nested below a roster row in the current workspace. */
export const WorkspaceAgentBuckets = ({ tree }: { tree: PeopleAgentsTree }) => {
  const { token } = useAuthSession()
  return (
    <div
