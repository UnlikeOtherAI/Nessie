...
const remedies: Record<string, string> = {
  ...
  receiver_delivery_failed: 'Results are saved, but the receiver could not be reached. Check its conversation and retry delivery.',
  ...
  processor_resource_setup_required: 'Update and reconnect the local executor to enable shared request limits.',
  resource_missing: 'The shared processor connection is missing. Reconnect the local executor.',
  ...
  processor_search_binding_changed: 'The search executor changed. Review the selected processor and retry this item.',
  processor_search_fence_missing: 'The search execution was interrupted. Retry this item after its processor stops.',
  processor_unapproved_tool: 'The model requested a tool this processor cannot use. Review its research setup and instructions.',
  ...
  task_set_authorization: 'Your access needs reauthorization. Restore your organization access before retrying.',
  ...
  receiver_source_access_required: 'The receiver or its conversation cannot read these results. Review its source permissions.',
  receiver_configuration_changed: 'The receiver changed during delivery. Review the destination before retrying delivery.',
