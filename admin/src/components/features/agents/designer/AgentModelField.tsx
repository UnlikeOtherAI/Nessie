  ...
  return (
    <div className="grid gap-1.5">
      ...
      <ModelCombobox
        ...
        id="agent-model"
        onLinkSubscription={() => { window.open('/settings/accounts?tab=inference', '_blank', 'noopener,noreferrer') }}
        onSelect={onSelect}
        options={options}
      ...
      <p className="text-xs leading-5 text-[color:var(--tx3)]">
        ...
        <Link className="underline" to="/settings/accounts?tab=inference">Connected accounts</Link>.
