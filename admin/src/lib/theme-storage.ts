...
/**
 * The two themes a sign-in page may paint. The IdP is handed a concrete
 * palette, never `system` (which is a question, not an answer) and never
 * `organization` (which the IdP cannot resolve).
 */
