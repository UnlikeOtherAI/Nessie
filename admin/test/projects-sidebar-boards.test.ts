...
test('every project section row carries a glyph, and Board is plural', () => {
  ...
  assert.match(sidebar, /<BoardIcon/)
  assert.match(source('components/kanban/BoardIcon.tsx'), /icon=\{BOARD_ICON\}/)
})
