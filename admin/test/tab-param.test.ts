...
test('every tab host resolves its tab through the one hook', () => {
  ...
  const hosts: ReadonlyArray<readonly [string, string]> = [
    ...
    ['../src/components/features/agents/page/NewAgentFlow.tsx', 'mode'],
    ['../src/components/features/projects/kanban/TaskDialog.tsx', 'taskTab'],
    ['../src/components/shared/ChannelSettingsDialog.tsx', 'channelSettingsTab'],
    ['../src/components/features/triggers/useTriggersPageState.ts', 'status'],
    ['../src/components/features/agents/page/AgentPage.tsx', 'tab'],
