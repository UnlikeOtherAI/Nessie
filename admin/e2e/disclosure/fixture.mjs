...
export const seedFixture = async (pipeline, seedScope, groupId) => {
  ...
  await prisma.$transaction([
    ...
    prisma.toolRegistryEntry.upsert({
      where: { organizationId_scopeKey_toolId: { organizationId: scope.organizationId, scopeKey: 'builtin', toolId: 'message_search' } },
      create: {
        builtin: true, description: 'Search messages in channels visible to the acting person.', enabled: true,
