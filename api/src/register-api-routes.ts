...
import { registerPlatformAnnouncementRoutes } from './routes/platform-announcements.js'
...
import { registerTicketWorkRoutes } from './routes/ticket-work.js'
...
import { registerStandingPolicyViewRoutes } from './routes/standing-policy-views.js'
...
export const registerApiRoutes = (app: FastifyInstance, deps: RouteDeps): void => {
  ...
  registerPlatformAnnouncementRoutes(app, deps)
  ...
  registerTicketWorkRoutes(app, deps)
