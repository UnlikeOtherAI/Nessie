...
export const buildDeepWaterLaunchMessage = (
  ...
  return [
    ...
    'Immediately after resolving the terminal status, report, status detail, and exact Ledger cost, call deep_water_run_update with the terminal status and accounting fields. This update is mandatory and must succeed before any optional Knowledge drafting starts.',
