...
const MESSAGES: Record<string, [number, string]> = {
  ...
  ATTACHMENT_NOT_REMOVABLE: [403, 'That file is a copy the external source keeps; it cannot be removed here.'],
  ATTACHMENT_ALREADY_REMOVED: [409, 'That file is already marked as removed.'],
  LABEL_NOT_ON_BOARD: [400, 'That label is not on this ticket\'s board.'],
  LABEL_NOT_IN_TASK_SOURCE: [400, 'That label belongs to a different source than this ticket'],
