...
const teams: TeamRow[] = [
  { id: teamId, organizationId, externalTeamId: externalTeamId, name: 'Design' },
  // Bound to no UOA team — a purely local team.
  { id: localTeamId, organizationId, externalTeamId: null, name: 'Local only' },
]
...
const actorContextFor = (
  ...
  actionContext: { requestId: 'req-team-avatar' },
})
