...
// released for agents, and a workflow can never use one, so both tools refuse
// it with a sentence that says what to use instead — before resolving the
// acting member or reading anything.
