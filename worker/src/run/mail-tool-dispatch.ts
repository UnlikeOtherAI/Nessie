...
// The connected-mail, Gmail and calendar families share a user-controlled
// account boundary. Keep their dispatch together so the generic run dispatcher
// remains orchestration rather than a growing catalogue switchboard.
export const dispatchMailTool = (
  toolName: string,
