...
(split out to keep this plan under the repo's file-length cap).

### 5d. Tabs, last state and resume (2026-09-06)

The agent's browser now keeps its tabs, shows where it left off in the chat's
Browser panel, and comes back for a person who taps the window. What that
