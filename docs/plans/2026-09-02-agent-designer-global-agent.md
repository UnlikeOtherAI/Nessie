...
2. **The Designer at work.** Split in two, built in parallel: 2a is the D3 gate
   arm, the surface/interactive plumbing and the delegation-predicate re-key;
   **2b — tools, catalogue and persona — is implemented 2026-09-02:**
