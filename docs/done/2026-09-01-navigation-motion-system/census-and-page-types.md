# The bounce, the census, and the page types

Chapter of [One navigation framework](overview.md). Why the phone push
overshot, what the admin already had, and the closed set of page types the
