...
It publishes only to loopback: SMTP/STARTTLS on `3025`, IMAP/STARTTLS on
`3143`, SMTPS on `3465`, and IMAPS on `3993`. Its test-only accounts are
...
test, not a Nessie production-client test: connected-mail production code
